 ...
 */
@Service
public class Implementation implements ClienteService {

	// Singleton: Injetar os componentes do Spring com @Autowired.
	@Autowired
	private ClienteRepository clienteRepository; //Sem Spring aqui acrescentaria "= new ClienteRepository();"
	@Autowired
	...
	private void salvarClienteComCep(Cliente cliente) {
		...
		// Inserir Cliente, vinculando o Endereco (novo ou exi,stente).
